...
public class DataModel implements Serializable{
    ...
    private static final long serialVersionUID = 1L; // Para mantener compatibilidad en la serialización
    ...
    public DataModel(String URLxmlFile) {
        try {
            ...
            this.xmlFile = db.parse(URLxmlFile);
        } catch (Exception e) {
